...
//
// #85: this module lives in the DOM-FREE @wikistead/macro-render package (re-exported from
// apps/web for the editor) so the SERVER can consume the same XSS boundary when rendering
// published/static HTML — a single source of truth for client and server.
