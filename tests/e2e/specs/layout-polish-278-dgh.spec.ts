...
// #278G, MIGRATED by④ (2026-07-17): the old pin held edit and Reading tab widths equal,
...
test("#278G (④): edit tabs reserve the ×-slot uniformly; Reading drops it", async ({ browser }) => {
  const page = await (await browser.newContext()).newPage();
