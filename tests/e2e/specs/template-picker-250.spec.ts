...
// #267the REAL standing QA torture-page body (fixtures/torture-page.md — copied from the
...
for (const vp of [{ width: 1310, height: 940 }, { width: 1280, height: 720 }]) {
  test(`#267the real torture-page preview stays inside the dialog at ${vp.width}×${vp.height}`, async ({ browser }) => {
