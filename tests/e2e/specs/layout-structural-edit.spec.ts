...
// #278 A: clicking a column/tab must NOT scroll the editor. The addLayoutItem dispatch dropped
...
test("#278 A: adding a column via ＋ does not scroll the editor to the top", async ({ browser }) => {
