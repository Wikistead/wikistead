...
// #345 Lezer parses LAZILY — on a FRESH LOAD (no enterEdit; the state every reader lands in)
...
test("#345 a fresh-loaded long page has the FULL TOC and the highlight follows to the bottom", async ({ browser }) => {
