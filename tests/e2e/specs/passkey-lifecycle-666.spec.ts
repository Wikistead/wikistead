...
test("#666: a passkey registered from the screen comes off by signing with itself", async ({ page }) => {
  ...
  // ── register ───────────────────────────────────────────────────────────────────────────────────
  // #653 enrolment takes no name. The key is registered first and named afterwards, which is
  ...
  // #673 and what it SAYS names what went. This is the ceremony path — `factor-kind-naming`
