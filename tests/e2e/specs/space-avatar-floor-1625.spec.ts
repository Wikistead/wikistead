...
// #284 the REAL failure was device-only — Chrome's minimum-font-size setting (ja/CJK locales default it to
...
test("#284 chip ratio stays constant even under a 10px font floor", async ({ page }) => {
  await openDemo(page);
