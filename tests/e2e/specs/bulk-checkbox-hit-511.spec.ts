...
// #511 the bulk-select checkbox was a bare 13×13px input — the only clickable spot was the box
...
test("#511 the row checkbox is hittable around itself, and the title still navigates", async ({ page }) => {
  await openDemo(page);
