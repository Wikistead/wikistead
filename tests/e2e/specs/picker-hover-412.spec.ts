...
// hover-selection was yanked back to the first hit by theauto-select effect, because only KEYBOARD
...
// E: hovering a row must MOVE the highlight to it and KEEP it there (pre-fix, theauto-select
