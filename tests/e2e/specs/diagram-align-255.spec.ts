...
// the widget's cm-lp-align-* class (the #255 updateDOM fix swaps the align class IN PLACE on an
...
// #255 changing a diagram's alignment must NOT jump the scroll position. The bug: an align-only
...
test("#255 changing a diagram's alignment does not jump the scroll position", async ({ browser }) => {
