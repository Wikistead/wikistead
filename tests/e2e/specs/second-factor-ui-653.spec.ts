...
test("#653: a factor can be enrolled from the screen, and only given up by proving it", async ({ page }) => {
  ...
  // ── enrol ───────────────────────────────────────────────────────────────────────────────────────
  // #653no name before enrolling — the row is named from the pencil once it exists (below).
  ...
  // #653it arrives unnamed and is named from the pencil — the walk a person makes now, and the
