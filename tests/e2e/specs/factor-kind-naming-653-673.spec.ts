...
// #653/ #673a row, and every sentence about it, says WHICH KIND it is.
//
...
test("#673the way to remove a factor is red standing still, like every other destructive one", async ({ page }) => {
  test.setTimeout(120_000);
