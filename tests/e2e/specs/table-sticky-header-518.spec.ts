...
// rows shown, the header pinned just below the app band as the page scrolls, and (the hard bug) a wide
...
test("#518 a :::table header FOLLOWS the page scroll (not a box), all rows shown, columns reachable", async ({ browser }) => {
