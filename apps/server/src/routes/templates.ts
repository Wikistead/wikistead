...
import { renderPlantuml } from '../plantuml-render.js' // #267 template preview plantuml render (faithful mirror of the page endpoint)
...
export async function saveTemplate(
  ...
  // asymmetry a review caught (#529 follow-up): a principal who cannot READ the space's templates
...
export async function templatesPlugin(app: FastifyInstance) {
  ...
  // #267 PlantUML render for the TEMPLATE preview — a faithful mirror of the page endpoint
