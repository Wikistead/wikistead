// #536 item 2: ONE principal = ONE role on a space. A manual add REPLACES the principal's other
...
describe('#536 one principal, one space role (replace semantics)', () => {
...
// #536 SUPERSEDES the two pins that used to live here ("manage is exempt, so the manager and the
...
// own.
describe('#536 a manager is demoted only by someone who said so', () => {
