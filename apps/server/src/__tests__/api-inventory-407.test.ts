...
const EXCLUDED_PATHS = new Set([
  ...
  // #650 / ADR-226: minting recovery codes is the same account-screen plumbing. The plaintext exists
  // exactly once, in the response that made it, and is shown to a person who is about to write it on
  ...
  // by the /auth/ prefix exclusion above. #1045 / ADR-259 §3.9 adds its opposite (unlinking) as the
  // same account-screen plumbing, one row down.
  '/me/connections', '/me/connections/:connectionId/link/start', '/me/connections/:connectionId/link',
