// #667 a write sent with NO BODY must not answer 500.
//
...
describe('#667 a bodyless write is a bad request, never a crash', () => {
  ...
  it('…and the one that was reported is refused the way its neighbours are', async () => {
    // The case found, kept by name as well — the walk above proves the class, this proves the
