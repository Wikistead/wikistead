...
describe('role-edit re-expansion (#420 increment 4, Fork B1)', () => {
  it('adding a capability grants it to every live assignment; removing revokes it — with themulti-source guard', async () => {
    ...
    try {
      ...
      // is STILL covered by r2 → the shared leaf survives (therole-edit reinforcement).
