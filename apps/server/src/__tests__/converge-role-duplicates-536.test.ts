...
describe('#536(5): one-shot duplicate convergence', () => {
  ...
  it('dry-run plans without writing; apply converges rows AND tuples; manage/mapping/unranked survive; ledger written', async () => {
    ...
    // #536SUPERSEDES the old expectation here (keep the strongest weak role, leave the manager
  ...
  // #536item 3: the production shape. A space CREATOR holds `manager` as a bare FGA leaf with no
