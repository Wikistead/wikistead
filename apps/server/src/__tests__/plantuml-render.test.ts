...
describe('renderPlantuml (#140 / ADR-074)', () => {
  ...
  // #342dark mode injects a READABLE-dark skinparam block (dark canvas + light text) into the source
...
// #525the caller must be able to tell an INVALID diagram (the author's error — mermaid shows a
