...
// Revoke custom domains the committed plan no longer includes (#721 / ADR-230 §2, ruling // no second grace — the domain goes at the commit, on the same clock as the seat freeze, because
