...
//   verify  LEGACY_EDITOR_TUPLES must be 0 (the completion criterion) before Step B.
...
// The completion criterion: zero legacy member-principal `editor` tuples remain.
