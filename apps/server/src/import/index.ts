...
/** The same shape WITHOUT the leading `!` — a file link rather than an embed (#712leftover ①). */
const FILE_LINK = /\[([^\]]*)\]\(([^)\s]+)\)/g
...
function rewriteBody(
  ...
  // #712leftover ① / c5496-B: a LINK to an attached file — `[paper](attachments/paper.pdf)` — is
