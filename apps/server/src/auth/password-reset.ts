...
export async function completePasswordReset(
  ...
  return db.tx(async (tx: Sql) => {
    ...
    // UPDATE, never INSERT. If the row vanished between minting and completing (the member was
    // removed), this writes nothing and the reset answers as a dead link rather than resurrecting a
    // credential for someone who is gone.
