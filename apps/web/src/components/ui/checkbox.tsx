...
function Checkbox({
  ...
  return (
    <CheckboxPrimitive.Root
      data-slot="checkbox"
      className={cn(
        // #389 the 1px frame is an inset ring, not a border, so the padding box and the border
      ...
      {...props}
    >
      {/* #389 the glyph box IS the box's rect (inset-0 against a padding box that the inset
