...
// widget needs — #525200 image → the blob, 204 → a silent degrade (the operator has not
...
describe("makeDiagramRenderer (#140 / ADR-074)", () => {
  ...
  it("#525422 says the DIAGRAM is invalid (so the widget can show it, like mermaid)", async () => {
  ...
  it("#525503 and a network error are an OUTAGE, kept distinct from a syntax error", async () => {
