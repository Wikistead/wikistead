  ...
  class {
    ...
    read(view: EditorView): Rect[] {
      ...
      for (const b of blocks) {
        ...
        // #453no atom-box wrap — the observer has locally raw-expanded this macro (Live per-
...
const macroPresenceOverlayTheme = EditorView.baseTheme({
  ...
  // #453chip-only mode — no ring at all (the observer raw-expanded / opened the editUI island,
