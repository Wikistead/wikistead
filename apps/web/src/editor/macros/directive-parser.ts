...
export { parseDirectiveOpen, isDirectiveClose, directiveExtension, resolveDirectiveRanges, parseDirectiveAttrs, serializeDirectiveAttrs, type ResolvedDirective } from "@wikistead/macro-render";
