...
// #278 NO fixed min-height — a short mermaid/plantuml source opened a mostly-empty box (the same
...
// IS code (the carve-out makes explicit).
const baseTheme = EditorView.theme({
  // #278 D: font size INHERITS the host editor (the main editor's code face size) rather than a fixed
