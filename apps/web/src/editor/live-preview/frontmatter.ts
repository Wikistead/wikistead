...
// #413the suggest trigger glyph — Lucide "chevron-down" as a trusted inline constant (the same
...
export class FrontmatterWidget extends WidgetType {
  ...
  toDOM(view: EditorView) {
    ...
    // #438the SHARED ring class (cm-lp-atom-sel) — the widget shipped with its own
    ...
    if (this.canEdit) {
      ...
      // #413CUSTOM autocomplete (the native <datalist> is retired — its dropdown only filled on
