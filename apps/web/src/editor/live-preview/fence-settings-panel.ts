...
// #456item 2: a KEYBOARD path to the settings. Right-click was the only way in; this opens the panel
...
// #456item 2: the discoverable affordance. Hovering a code fence shows a small ✎ button anchored at
