...
class MathWidget extends WidgetType {
  ...
  toDOM(view: EditorView) {
    ...
    // before a callout made the callout region skip every other line). the project design notes: height changes reach CM
    // via the ResizeObserver + requestMeasure shared by ALL block widgets — math was the one missing it.
