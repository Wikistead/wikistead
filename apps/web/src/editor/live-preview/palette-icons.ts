...
//
// #357EVERY shipped palette command has an EXPLICIT icon here — the `palette-icons.test` fails if any
...
// #357list-collapse (rows + a collapse chevron), NOT square-chevron-down — the boxed chevron read too
...
// #357does this id have an EXPLICIT icon (not the fallback)? The coverage test asserts every shipped
