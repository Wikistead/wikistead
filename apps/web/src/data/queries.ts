...
// name (#536the client never hashes); a principal straight from the assignments listing is
// also accepted.
...
export function useMyFactors() {
  ...
  return useQuery({
    queryKey: ["me", "factors"],
    // #686 family A ②: the STANCE comes back too, and is kept. The screen used to drop it and promise a
