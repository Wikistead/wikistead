...
/* #636 (user ruling): the file ends with room. A document that stops flush against the bottom of
   the window reads as one that was cut off rather than one that finished — the ruling: with no room at
   the bottom, scrolling to the end still feels like the page is clipped. Said about the SAVED FILE.
