...
import { SidebarTreeSkeleton, useDelayedFlag } from "../ui/Skeleton"; // #457loading vs empty
  ...
  return (
    <nav ref={navRef} className="flex h-full flex-col gap-0.5 overflow-auto p-2 text-[length:var(--text-ui)]" data-testid="guest-sidebar" aria-label={heading}>
      ...
      {error ? (
        ...
        // #457loading, not empty — the empty wording below must never show for a tree that
