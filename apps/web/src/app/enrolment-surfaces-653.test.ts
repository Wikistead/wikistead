...
// #653the QR shipped on ONE of the two screens that can start an enrolment.
//
...
describe("#653: every enrolment surface offers both ways in", () => {
  ...
  it("draws the QR from the server's own string, never a rebuilt one", () => {
    //'s condition. If a screen assembles `otpauth://` itself, the spelling of issuer, digits and
