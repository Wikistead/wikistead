...
function GuestPageContent({ minted, onBack, startEditing = false, onTitleChange }: { minted: GuestToken; onBack?: () => void; startEditing?: boolean; onTitleChange?: () => void }) {
  ...
  // module duplication). #361the draft flip + POST run through the shared per-page serial
  ...
  // against the user's final optimistic flip — the member-sidemechanism, mirrored here).
