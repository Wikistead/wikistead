...
// #273pdf.js v6.1.200 calls the TC39 "Map/Set upsert" methods (getOrInsertComputed / getOrInsert),
...
// #273the worker CANNOT be a URL here. This document runs in an OPAQUE origin (sandbox=allow-scripts,
