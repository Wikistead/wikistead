...
export function Toc({
  ...
  // #345auto-follow — keep the current item in view as the reader scrolls a long TOC (no-op for a short
        ...
        <li key={h.slug}>
          <button
            ...
            className={cn(
              ...
              // #345LIGHT layer — a section that's on screen but not the current one reads a touch
