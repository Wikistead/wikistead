// #721 the two things the review found on the custom-domain surface, measured on the
...
// value in DIFFERENT boxes, which is why split the copy buttons) could not tell which was
