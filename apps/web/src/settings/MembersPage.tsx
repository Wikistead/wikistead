...
export function MembersPage() {
  ...
  // #638the invitation-link dialog is opened by a row and holds NO secret until the reader asks
          ...
          <ListBox data-testid="invite-list">
            {invites.map((i) => (
              <ListRow key={i.id} data-testid="invite-row" data-invite={i.id}>
                ...
                {/* #638one button, and it is a NOUN. Two lived here — "new link" and "resend"
