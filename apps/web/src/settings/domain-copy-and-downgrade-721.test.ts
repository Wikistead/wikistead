...
//      adding one back means proving ownership again (ADR-230 §3, the itemfound missing).
//
...
describe("#721①: the DNS challenge is copyable field by field", () => {
  ...
  it("uses the product's existing copy control rather than a second spelling of one", async () => {
    ...
    // The idiomnamed: an icon button labelled with adminApi.copy. If OneTimeSecret and the DNS
