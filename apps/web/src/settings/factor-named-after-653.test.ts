...
// which the row already says by itself (#653's fallback).
//
// It also removes the last thing left standing in #686's zero-entrance panel: when the stance
...
describe("#653no name is asked for before the factor exists", () => {
  ...
  it("an unnamed row still says what it is", () => {
    // The fallback #653landed is what makes an unnamed row readable, and it is now load-bearing
