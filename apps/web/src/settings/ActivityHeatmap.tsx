...
// #483month/year labels above the grid + Mon/Wed/Fri gutter labels (the GitHub convention), and
...
// #483the month-label band, derived from the SAME grid geometry as the cells (start = the
