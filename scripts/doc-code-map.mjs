...
export const DOC_CODE_MAP = [
  ...
  {
    // #729a dialog is a surface a user operates, and the route walk cannot see it — it has no
...
export const SURFACE_DOCS = {
  ...
  'web-route': {
    // #726the home landing. Mostly it redirects (first visible space → its home page), so the
